    ...
    ? createPortal(
        <AnimatePresence>
          <motion.div
            ...
            className="fixed top-0 left-0 h-full w-[75%] sm:w-[60%] z-999 bg-linear-to-b
          ...
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                className="absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-lg border border-gray-200 p-3 z-999"
              >
