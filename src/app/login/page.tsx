    ...
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative">
      ...
      >
        ...
        <div className="relative">
          ...
          />
          {showPassword ? (
            <EyeOff className="absolute right-3 top-3.5 w-5 h-5 text-gray-500 cursor-pointer" />
          ) : (
        ...
        <div
          className="w-full flex items-center justify-center gap-3 border border-gray-300 hover:border-gray-50 py-3 rounded-xl text-gray-700 font-medium transition-all duration-200 cursor-pointer"
      ...
      >
        Want to Create an account ? <LogIn />
