  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-green-50 to-white py-16 px-4 relative">
      ...
      <motion.div
        ...
        className="bg-white w-full max-w-2xl shadow-2xl rounded-3xl border border-gray-100 p-8"
      >
        ...
        <form className="flex flex-col gap-6 w-full" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <label className="block text-gray-700 font-medium mb-1">
                Categorys <span className="text-red-500">*</span>
                <select
                  name="category"
                  className="w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all bg-white mt-1"
          ...
          <motion.button
            ...
            hover:shadow-xl disabled:opacity-60 transition-all
